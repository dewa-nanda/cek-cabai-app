<nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="{{asset('storage/image/WallpaperChili.jpeg')}}" class="h-8" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Cek Cabai App</span>
    </a>
...
{{-- <nav class="bg-gray-500 grid grid-cols-2 p-3 drop-shadow">
    ...
    <div class="grid grid-cols-5 text-center">
        <a href="/">Home</a>
        <a href="{{route('cekKesehatanView')}}">Cek Kesehatan</a>
        <a href="#">Riwayat Penyakit</a>
        <a href="#">About us</a>
