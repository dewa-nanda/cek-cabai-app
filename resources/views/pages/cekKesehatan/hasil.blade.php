...
@section('content')
    <div class="mx-auto container grid grid-cols-1 content-center min-h-screen md:grid-cols-2">
        <div class="hidden md:flex flex-col justify-center justify-self-center">
