                ...
                <div class="w-full p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    ...
                    <form class="mt-8 space-y-6" action="{{route("cekKesehatanAction")}}" method="POST">
                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <!-- Modal toggle -->
                            @if($gejala == null)
                                <button type="button" class="w-max text-white bg-blue-400 dark:bg-blue-500 cursor-not-allowed font-medium rounded-lg text-sm px-5 py-2.5 text-center" disabled>
                                    Tambah Gejala
                                </button>
                            @else
