                        ...
                        <div class="grid grid-cols-3 gap-6">
                            @foreach ($gejala as $key => $item)
                                <div class="flex items-center">
                                    <input id="checkbox-{{$item->id}}" name="gejala[{{$key}}]" type="checkbox" value="{{$item->id}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
