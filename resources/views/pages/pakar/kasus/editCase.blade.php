                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      ...
                      <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit Kasus Tanaman Cabai</span>
                    </div>
                  </li>
                </ol>
            </nav>
            ...
            <div style="background-color: #222831; min-width:50%" class="flex mx-auto rounded-xl min-h-96 gap-5">
                ...
                <section style="background-color: #31363F; border-left: 5px solid #76ABAE; width:60%" class="rounded-xl p-3 flex flex-col justify-center gap-3">
                    <div style="border-bottom: 2px solid #76ABAE" class="flex flex-col gap-1 pb-1">
                        <h1 class="text-3xl">Edit Kasus Terdahulu
                          <span class="bg-purple-100 text-purple-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-xl dark:bg-gray-700 dark:text-purple-400 border border-purple-400">
                            @if ($case->pakar == 1)
                              Base Knowladge
                            @else
                              Support Knowladge
                        ...
                        <p>Perbaiki pengetahuan sesuai dengan preferensi anda!</p>
                    </div>
                                                    ...
                                                    <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                                        ...
                                                        <li class="w-full dark:border-gray-600">
                                                            <div class="flex items-center ps-3">
                                                                ...
                                                                <label for="stp-{{$symptom->id}}" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Cukup Berpengaruh</label>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                  </div>
